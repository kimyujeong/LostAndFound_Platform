<?php
    ...
    //쿼리문 작성
    $sql="select L.lost_num, P.photo, L.cinema_num from lost_photo P, lost L, inquiry I where L.lost_num=I.lost_num and I.processing_state='승인대기중' and P.lost_num=L.lost_num order by lost_num";
