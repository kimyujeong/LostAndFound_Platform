    ...
    if( (($_SERVER['REQUEST_METHOD'] == 'POST') && isset($_POST['submit'])) || $android )
    {
        ...
        if(!isset($errMSG)) // 이름과 나라 모두 입력이 되었다면 
        {
            try{
                ...
                $stmt = $con->prepare('UPDATE ASK_LOST SET staff_num=:staff_num, ask_state=:ask_state, reject_detail=:reject_detail, flag=:flag WHERE ask_num=:ask_num');
