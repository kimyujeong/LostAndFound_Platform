<?php
    ...
    //쿼리문 작성
    $sql="select L.lost_num, P.photo, L.cinema_num from lost_photo P, lost L, inquiry I where L.lost_num = P.lost_num and I.lost_num=L.lost_num and I.processing_state='수령예정' order by L.lost_num asc";
