<?php
    ...
    //쿼리문 작성
    $sql="SELECT L.lost_num, P.photo, L.cinema_num, substr(L.expired_date,1,10) as expired_date from lost_photo P, lost L WHERE L.importance= 'A' and L.processing_state ='wait' and L.lost_num=P.lost_num order by lost_num";
